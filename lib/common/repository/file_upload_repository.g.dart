...
part of 'file_upload_repository.dart';
...
class _FileUploadRepository implements FileUploadRepository {
  _FileUploadRepository(this._dio, {this.baseUrl, this.errorLogger});
